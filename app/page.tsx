...
export default function Profile() {
  return (
    ...
    <div className="min-h-screen flex flex-col lg:flex-row bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 p-6 lg:p-12 transition-colors duration-300">
      ...
      <div className="lg:w-1/3 bg-gray-100 dark:bg-gray-800 rounded-xl p-6 mb-6 lg:mb-0 lg:mr-6 flex flex-col items-center text-center">
      ...
      <div className="lg:w-2/3 flex flex-col justify-between">
        {/* Main Info Section */}
        <div className="bg-gray-100 dark:bg-gray-800 rounded-xl p-6 flex flex-col justify-between mb-6">
          <div>
