            ...
            <div>
              ...
              <h3  className=" mb-4 space-x-5">
                I&apos;m Ismail, a passionate and innovative Junior Developer with a
                 ...
                 and a relentless drive for excellence, I bring a fresh perspective to software development.<p>  My journey is marked 
                 by hands-on experience in building dynamic web applications, solving complex problems, and delivering high-quality, 
                maintainable code. I am constantly exploring new technologies and methodologies to enhance my skills 
                and deliver solutions that not only meet but exceed user expectations.</p>
              </h3>
            </div>
            <div>
